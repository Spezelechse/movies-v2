...
<br><br>Wurden die Medien wirklich zurückgegeben?<br><br>
...
if(isset($_POST['id'])&&$_POST['setup']==2){
	...
	$sql = "UPDATE dvds SET borrower='', borrowed=0 WHERE mid=:id;";
	...
	if($countAktion==count($ids)){	
		echo "<br><br>Updaten erfolgreich";
		forward("index.php",2000);
	}
	else{
		$diff=count($ids)-$countAktion;
		echo "<br><br>Updaten fehlgeschlagen (".$diff.". Einträge wurden nicht geupdated)";
	}
}
?>